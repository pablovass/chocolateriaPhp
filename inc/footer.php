 ...
 ?>
	...
	<div class="copyright-bar bg-black">
		<div class="container">
          ...
          <p class="pull-left small">&copy; Copyright <?php echo $nombre; ?> <?php echo $apellidos; ?></p>

			</div>
			<div class="editContent">
        <p class="pull-right small">made in  <span class="fa fa-heart pomegranate"></span> Argentina</p>
